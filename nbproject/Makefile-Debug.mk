...
${OBJECTDIR}/libraries/DeckBuilder.o: libraries/DeckBuilder.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/libraries/DeckBuilder.o libraries/DeckBuilder.cpp

${OBJECTDIR}/Holding.o: Holding.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Holding.o Holding.cpp

${OBJECTDIR}/StrongHold.o: StrongHold.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/StrongHold.o StrongHold.cpp

${OBJECTDIR}/BlackCard.o: BlackCard.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BlackCard.o BlackCard.cpp

${OBJECTDIR}/Personality.o: Personality.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Personality.o Personality.cpp
...
${OBJECTDIR}/GreenCard.o: GreenCard.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/GreenCard.o GreenCard.cpp

${OBJECTDIR}/libraries/L5R_Library.o: libraries/L5R_Library.cpp 
	${MKDIR} -p ${OBJECTDIR}/libraries
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/libraries/L5R_Library.o libraries/L5R_Library.cpp

${OBJECTDIR}/libraries/TypeConverter.o: libraries/TypeConverter.cpp 
	${MKDIR} -p ${OBJECTDIR}/libraries
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/libraries/TypeConverter.o libraries/TypeConverter.cpp

${OBJECTDIR}/Follower.o: Follower.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Follower.o Follower.cpp

${OBJECTDIR}/libraries/PlayerComm.o: libraries/PlayerComm.cpp 
	${MKDIR} -p ${OBJECTDIR}/libraries
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/libraries/PlayerComm.o libraries/PlayerComm.cpp

${OBJECTDIR}/Province.o: Province.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Province.o Province.cpp
